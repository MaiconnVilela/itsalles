...
import 'criar_estudo_model.dart';
export 'criar_estudo_model.dart';

class CriarEstudoWidget extends StatefulWidget {
  const CriarEstudoWidget({super.key});

  @override
  State<CriarEstudoWidget> createState() => _CriarEstudoWidgetState();
}

class _CriarEstudoWidgetState extends State<CriarEstudoWidget> {
  late CriarEstudoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CriarEstudoModel());
