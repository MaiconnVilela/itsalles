...
import 'criar_estudo2_model.dart';
export 'criar_estudo2_model.dart';

class CriarEstudo2Widget extends StatefulWidget {
  const CriarEstudo2Widget({super.key});

  @override
  State<CriarEstudo2Widget> createState() => _CriarEstudo2WidgetState();
}

class _CriarEstudo2WidgetState extends State<CriarEstudo2Widget> {
  late CriarEstudo2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CriarEstudo2Model());
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              .emailAddressLoginTextController1,
                                          focusNode: _model
                                              .emailAddressLoginFocusNode1,
                                          onChanged: (_) =>
                                      ...
                                      Padding(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              .emailAddressLoginTextController2,
                                          focusNode: _model
                                              .emailAddressLoginFocusNode2,
                                          onChanged: (_) =>
                                              EasyDebounce.debounce(
                                            ...
                                            Padding(
                                              ...
                                              child: FFButtonWidget(
                                                onPressed: () async {
                                                  ...
                                                  await BacharelRecord
                                                      .collection
                                                      .doc()
                                                      .set(
                                                          createBacharelRecordData(
                                                        capa:
                                                            'https://firebasestorage.googleapis.com/v0/b/appteologia.appspot.com/o/Capas%2FWhatsApp%20Image%202024-11-08%20at%2015.51.52.jpeg?alt=media&token=b5677437-5c58-4436-82b7-4e5dcedd42d3',
                                                        aula: _model
                                                            .emailAddressLoginTextController2
                                                            .text,
                                                        titulo: _model
